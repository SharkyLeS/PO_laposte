...
# Add months, weekdays and hours variables
...
# One hot encoding for these three variables
grouped_data['month'], grouped_data['weekday'] = pd.Categorical(grouped_data['month']), \
                                                 pd.Categorical(grouped_data['weekday'])
dfDummies_month, dfDummies_weekday, dfDummies_hour = pd.get_dummies(grouped_data['month'], prefix='month'), \
                                                     pd.get_dummies(grouped_data['weekday'], prefix='weekday'), \
                                                     pd.get_dummies(grouped_data['hour'], prefix='hour')
